  ...
  return (
    ...
    <meta name="twitter:card" content="summary_large_image" />
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start w-[100%] max-w-[800px]">
        ...
        onClick={()=>{r.push("https://opengena.com/")}}>
          <div className="flex flex-col">
            <h1 className="font-semibold md:mt-5 md:m-auto px-2">Gerador de audio 📦</h1>
            <span className="text-sm px-2">Tecnologia que que utilizo no dia a dia para construir audios de maneira rapida e pratica.</span>
          </div>
